...
public class ConferenceRoomSelector extends BaseJFrame implements DateVetoPolicy{
	...
	public ConferenceRoomSelector(User user){
		this.user = user; // TODO username to screen fix adds, cal view
		// month view, day
		// TODO wash your azzz
		initialize();
	}
	...
	public void design(){
		...
		createLabel("Pick a Conference Room: ", 141, 11, 173, 14, font12);

		String[] rooms = repository.getRoomNames(); 
		JComboBox<String> roomChoice = new JComboBox<String>(rooms);

		roomChoice.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
			}
		});
		roomChoice.setBounds(181, 44, 76, 28);
		getContentPane().add(roomChoice);

		// date time menu components
		createLabel("Pick a Date and Time: ", 153, 94, 140, 14, font12);

		JPanel panel1 = new JPanel();
		panel1.setBounds(10, 135, 414, 47);
